...
def _anime2selfie():
    ...
    return Response(FileWrapper(output_file_in_memory), mimetype='image/jpeg', direct_passthrough=True)  # for uwsgi
...
@uwsgidecorators.postfork  # XXX: choose one of this (lazy?)
